...
const _hoisted_1 = /* @__PURE__ */ vue.createVNode("span", { class: "el-checkbox__inner" }, null, -1);
const _hoisted_2 = {
  key: 0,
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return vue.openBlock(), vue.createBlock("label", {
    ...
    _ctx.$slots.default || _ctx.label ? (vue.openBlock(), vue.createBlock("span", _hoisted_2, [
      vue.renderSlot(_ctx.$slots, "default"),
      !_ctx.$slots.default ? (vue.openBlock(), vue.createBlock(vue.Fragment, { key: 0 }, [
